...
//     Searches devices and returns the number of found devices.
//	   Also fills the given array of rom identifiers
...
unsigned char  dallasWriteRAM(dallas_rom_id_T* rom_id, unsigned short address, unsigned char len, unsigned char* data);
