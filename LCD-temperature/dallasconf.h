...
#define DALLAS_PORT					PORTC		// the output port
#define DALLAS_DDR					DDRC		// the DDR port
#define DALLAS_PORTIN				PINC		// the input port
#define DALLAS_PIN					1			// the pin number [0-7]
